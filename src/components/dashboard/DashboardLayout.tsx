    ...
    return (
        <div className="min-h-screen bg-black flex">
            ...
            <main className="flex-1 ml-72 relative">
                ...
                {/* Dashboard Header */}
                <header className="h-20 border-b border-white/5 flex items-center justify-between px-12 bg-black/40 backdrop-blur-xl sticky top-0 z-40">
                    <h1 className="font-bebas text-4xl text-white tracking-widest uppercase">
                        {title || 'Dashboard'}
                    </h1>
                    <div className="flex items-center gap-6">
                        <div className="text-right">
                            <p className="text-[10px] text-gray-500 font-bold uppercase tracking-widest">Saldo de Pontos</p>
                            <p className="text-xl text-white font-bebas tracking-wider">12.450 <span className="text-granada-red font-sans text-xs">PTS</span></p>
                        </div>
