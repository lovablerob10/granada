...
export const Sidebar: React.FC = () => {
    ...
    return (
        <aside className="w-72 h-screen bg-black/60 backdrop-blur-2xl border-r border-white/5 shadow-[5px_0_30px_rgba(0,0,0,0.5)] flex flex-col fixed left-0 top-0 z-50">
